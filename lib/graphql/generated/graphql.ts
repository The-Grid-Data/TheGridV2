...
export type JsonAggExp = {
  __typename?: 'JsonAggExp';
  _count: Scalars['Int']['output'];
  _count_distinct: Scalars['Int']['output'];
};

export type JsonBoolExp = {
...
export type Validation = {
  ...
  comment?: Maybe<Scalars['String2']['output']>;
  committedAt?: Maybe<Scalars['Timestamp']['output']>;
  createdAt?: Maybe<Scalars['Timestamp']['output']>;
  destinationValue?: Maybe<Scalars['String2']['output']>;
  field?: Maybe<Scalars['String2']['output']>;
  id: Scalars['Int64']['output'];
  isPending?: Maybe<Scalars['String2']['output']>;
  referencedField?: Maybe<Scalars['String2']['output']>;
  referencedTable?: Maybe<Scalars['String2']['output']>;
  resolution?: Maybe<Scalars['Json']['output']>;
  resolvedAt?: Maybe<Scalars['Timestamp']['output']>;
  resolvedBy?: Maybe<Scalars['String2']['output']>;
  rootId?: Maybe<Scalars['String2']['output']>;
  rowId?: Maybe<Scalars['String2']['output']>;
  sourceValue?: Maybe<Scalars['String2']['output']>;
  table?: Maybe<Scalars['String2']['output']>;
  updatedAt?: Maybe<Scalars['Timestamp']['output']>;
  updatedBy?: Maybe<Scalars['String2']['output']>;
  updatedFrom?: Maybe<Scalars['String2']['output']>;
};

export type ValidationAggExp = {
  __typename?: 'validationAggExp';
  _count: Scalars['Int']['output'];
  comment: StringAggExp2;
  committedAt: TimestampAggExp;
  createdAt: TimestampAggExp;
  destinationValue: StringAggExp2;
  field: StringAggExp2;
  id: Int64AggExp;
  isPending: StringAggExp2;
  referencedField: StringAggExp2;
  referencedTable: StringAggExp2;
  resolution: JsonAggExp;
  resolvedAt: TimestampAggExp;
  resolvedBy: StringAggExp2;
  rootId: StringAggExp2;
  rowId: StringAggExp2;
  sourceValue: StringAggExp2;
  table: StringAggExp2;
  updatedAt: TimestampAggExp;
  updatedBy: StringAggExp2;
  updatedFrom: StringAggExp2;
};
...
export type ValidationBoolExp = {
  ...
  comment?: InputMaybe<StringBoolExp2>;
  committedAt?: InputMaybe<TimestampBoolExp>;
  createdAt?: InputMaybe<TimestampBoolExp>;
  destinationValue?: InputMaybe<StringBoolExp2>;
  field?: InputMaybe<StringBoolExp2>;
  id?: InputMaybe<Int64BoolExp>;
  isPending?: InputMaybe<StringBoolExp2>;
  referencedField?: InputMaybe<StringBoolExp2>;
  referencedTable?: InputMaybe<StringBoolExp2>;
  resolution?: InputMaybe<JsonBoolExp>;
  resolvedAt?: InputMaybe<TimestampBoolExp>;
  resolvedBy?: InputMaybe<StringBoolExp2>;
  rootId?: InputMaybe<StringBoolExp2>;
  rowId?: InputMaybe<StringBoolExp2>;
  sourceValue?: InputMaybe<StringBoolExp2>;
  table?: InputMaybe<StringBoolExp2>;
  updatedAt?: InputMaybe<TimestampBoolExp>;
  updatedBy?: InputMaybe<StringBoolExp2>;
  updatedFrom?: InputMaybe<StringBoolExp2>;
};
...
export type ValidationOrderBy = {
  ...
  committedAt?: InputMaybe<OrderBy>;
  createdAt?: InputMaybe<OrderBy>;
  destinationValue?: InputMaybe<OrderBy>;
  field?: InputMaybe<OrderBy>;
  id?: InputMaybe<OrderBy>;
  isPending?: InputMaybe<OrderBy>;
  referencedField?: InputMaybe<OrderBy>;
  referencedTable?: InputMaybe<OrderBy>;
  resolution?: InputMaybe<OrderBy>;
  resolvedAt?: InputMaybe<OrderBy>;
  resolvedBy?: InputMaybe<OrderBy>;
  rootId?: InputMaybe<OrderBy>;
  rowId?: InputMaybe<OrderBy>;
  sourceValue?: InputMaybe<OrderBy>;
  table?: InputMaybe<OrderBy>;
  updatedAt?: InputMaybe<OrderBy>;
  updatedBy?: InputMaybe<OrderBy>;
  updatedFrom?: InputMaybe<OrderBy>;
};
