...
const documents = {
    ...
    "\n  query getProductsLayersDictionary {\n    products {\n      id\n      name\n      description\n    }\n  }\n": types.GetProductsLayersDictionaryDocument,
    "\n  query getAssetsDictionary {\n    assets {\n      id\n      name\n      description\n    }\n  }\n": types.GetAssetsDictionaryDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment ProfileInfoFragment on ProfileInfos {\n    rootId\n    id\n    name\n    tagLine\n    descriptionShort\n    descriptionLong\n    foundingDate\n    profileType {\n      id\n      name\n      definition\n    }\n    profileStatus {\n      id\n      name\n      definition\n    }\n    profileSector {\n      id\n      name\n      definition\n    }\n    urls(order_by: { urlTypeId: Asc }) {\n      id\n      url\n      urlType {\n        name\n        id\n        definition\n      }\n    }\n  }\n"): typeof import('./graphql').ProfileInfoFragmentFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query getProductsLayersDictionary {\n    products {\n      id\n      name\n      description\n    }\n  }\n"): typeof import('./graphql').GetProductsLayersDictionaryDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query getAssetsDictionary {\n    assets {\n      id\n      name\n      description\n    }\n  }\n"): typeof import('./graphql').GetAssetsDictionaryDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
